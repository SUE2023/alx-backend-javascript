...
describe('calculateNumber', () => {
  describe('type == "SUM"', () => {
    ...
    it('positive numbers (roundeddown)', () => {
      assert.strictEqual(calculateNumber('SUM', 2.3, 1.0), 3);
    });

    it('positive numbers (roundedup)', () => {
      assert.strictEqual(calculateNumber('SUM', 2.7, 1.0), 4);
    });
